...
ACTION_KINDS = (
    ...
    "report",      # progress report to Diamond: {progress,steps,directions,knowledge}
...
_SYSTEM_PROMPT = (
    ...
    "Diamond monitors the whole project and dispatches help on its own; you never grade difficulty yourself. "
    "Use bash to run sandbox commands, tool to call an MCP tool {server,tool,args}, memory to recall "
    "past experience {query}, report to share progress and next directions with Diamond "
    "{progress,steps,directions,knowledge}, conclude to record a confirmed fact for your "
