...
Web path/directory brute-force scanner.

## 用途与适用场景

Discover hidden endpoints, backup files, admin panels.
...
- 常用入口：`python dirsearch.py`
- 镜像路径：`tools/dirsearch/dirsearch`

## 常用工作流

1. 在 Member 工作目录中确认附件、目标地址和授权范围。
2. 按题目类型使用 `python dirsearch.py` 进行最小化探测。
